...
```
$ cd
$ git clone https://github.com/heyztb/.tmux.git
...
```
$ git clone https://github.com/heyztb/.tmux.git "/path/to/oh-my-tmux"
...
[my own Vim configuration]: https://github.com/heyztb/.vim.git
